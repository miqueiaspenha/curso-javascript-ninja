...
carro.obterMarcaModelo = function () {
  return `Esse carro é um ${pessoa.obterMarca()} ${pessoa.obterModelo()}`;
};
...
carro.adicionarPessoas = function (numPessoas) {
  ...
  if (totalPessoas > carro.assentos) {
    var numPessoas = carro.assentos - carro.quantidadePessoas;
    var descPessoa = numPessoas === 1 ? "pessoa" : "pessoas";
    return `Só cabem mais ${numPessoas} ${descPessoa}!`;
  }
