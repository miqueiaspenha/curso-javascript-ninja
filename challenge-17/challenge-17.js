...
(function () {
  ...
  */
  ...
  let newText = texto.replace(/Manuel Marques de Sousa/, 'Miqueias Penha')
  console.log(newText);
  ...
  */
  ...
  newText = texto.replace(/brasileiro/, 'cearense')
  console.log(newText);
  ...
  */
  ...
  newText = texto.replace(/[D-Hd-h]/g, 0);
  console.log(newText);
  ...
  */
  ...
  newText = texto.replace(/O Centauro de Luvas/, function (text) {
  ...
  */
  ...
  console.log('\nReplace de datas:');
  newText = texto.replace(regexDate, replaceDate);
  console.log(newText);
})();
