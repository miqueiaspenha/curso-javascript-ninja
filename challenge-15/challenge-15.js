...
(function () {
  ...
  */
  ...
  let maria = new Person('Maria', 'Silva', 22);
  let joao = new Person('João', 'Oliveira', 30);
  let marcos = new Person('Marcos', 'Souza', 25);
  ...
  */
  ...
  console.log(
    `${marcos.getFullName()} agora tem ${marcos.addAge(4).getAge()} anos.`
  );
})();
